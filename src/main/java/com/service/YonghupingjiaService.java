...
public interface YonghupingjiaService extends IService<YonghupingjiaEntity> {
    ...
    List<Map<String, Object>> selectValue(Map<String, Object> params,Wrapper<YonghupingjiaEntity> wrapper);

    List<Map<String, Object>> selectTimeStatValue(Map<String, Object> params,Wrapper<YonghupingjiaEntity> wrapper);
    
    List<Map<String, Object>> selectGroup(Map<String, Object> params,Wrapper<YonghupingjiaEntity> wrapper);
}
