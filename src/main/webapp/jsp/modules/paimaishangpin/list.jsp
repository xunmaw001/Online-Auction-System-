...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">拍卖商品管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>拍卖商品管理</span></li>
								<li class="breadcrumb-item active"><span>拍卖商品列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">拍卖商品列表</h3>							
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var crossBtn0 = document.createElement('button');
            		crossBtn0.innerHTML = "竞拍"
			crossBtn0.setAttribute("type","button");
			crossBtn0.setAttribute("class","btn btn-primary btn-sm");
			crossBtn0.setAttribute("onclick","crossTable(" + JSON.stringify(item) + ",'yonghujingpai','','[1]','已参与竞拍该商品！')");
			if(crossBtnControl('竞拍') == true){
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("paimaishangpin/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function discussList(id) {
            ...
            window.location.href = "../discusspaimaishangpin/list.jsp"
        }
		//清除会重复渲染的节点
        function clear(){
	...
	function getSum(colName){
		http("paimaishangpin"+colName,"GET",{
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"paimaishangpin");
