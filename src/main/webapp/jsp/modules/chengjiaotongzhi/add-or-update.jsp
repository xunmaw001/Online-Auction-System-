...
<body>
		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑成交通知</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>成交通知管理</span></li>
								<li class="breadcrumb-item active"><span>编辑成交通知</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">成交通知信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>成交时间</label>
										<div id="chengjiaoshijianDate" class="input-append date form_datetime">
											<input id="chengjiaoshijian-input" name="chengjiaoshijian" size="20" type="text" readonly>
	...
	<script>
		...
		var tableName = "chengjiaotongzhi";
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "chengjiaotongzhi/info/" + id,
		...
		function submit() {
			...
			if(validform() ==true && compare() == true){
				...
				if(crossrefid && crossuserid) {
					...
					http("chengjiaotongzhi/page","GET",{
						page:1,
						limit:10,
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("chengjiaotongzhi/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("chengjiaotongzhi/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function dateTimePick(){
			...
			$("#chengjiaoshijian-input").val(getCurDateTime());
			$("#chengjiaoshijianDate").datetimepicker({ 
				autoclose: true,
		...
		function calculationSE(colName){
			//单列求和接口
			http("chengjiaotongzhi"+colName,"GET",{
		...
		function dataBind(){
			...
			$("#chengjiaoshijian-input").val(ruleForm.chengjiaoshijian);
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.chengjiaoshijian != null && res.data.chengjiaoshijian != ''){

						$("#chengjiaoshijian-input").val(res.data.chengjiaoshijian);
						$('#chengjiaoshijianFileName').val(res.data.chengjiaoshijian)
					}
