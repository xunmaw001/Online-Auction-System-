...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">成交通知管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>成交通知列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">成交通知列表</h3>							
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('chengjiaoshijian')">成交时间<i id="chengjiaoshijianIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var chengjiaoshijianCell  = document.createElement('td');

						  chengjiaoshijianCell.innerHTML = item.chengjiaoshijian;


			row.appendChild(chengjiaoshijianCell);
			...
			var crossBtn0 = document.createElement('button');
            		crossBtn0.innerHTML = "评价"
			crossBtn0.setAttribute("type","button");
			crossBtn0.setAttribute("class","btn btn-primary btn-sm");
			crossBtn0.setAttribute("onclick","crossTable(" + JSON.stringify(item) + ",'yonghupingjia','','[1]','已有评价信息！')");
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("chengjiaotongzhi/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"chengjiaotongzhi");
        ...
        function pay(item){
			...
			window.sessionStorage.setItem('tableName',"chengjiaotongzhi");
