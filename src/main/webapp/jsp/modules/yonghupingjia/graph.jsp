...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">用户评价统计</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>用户评价统计</span></li>
							</ol>
						</div>
					</div>
				</div>
	...
	function draw(){
		...
		myChart.setOption({
			title: {text : '用户评价',left: 'center',top: 20},
			tooltip: {
				trigger: 'item',
	...
	$.ajax({ 
		type: "GET",
		//url: baseUrl+"value/yonghupingjia/"+xColumnName+'/'+yColumnName,
		url: baseUrl+"yonghupingjia/value/"+xColumnName+'/'+yColumnName,
		data:{ },
	...
	function group(colName){
		$.ajax({ 
			type: "GET",
			//url: baseUrl+"group/yonghupingjia/"+colName,
			url: baseUrl+"yonghupingjia/group/"+colName,
			data:{	tableName: "yonghupingjia",
					columnName: colName
					},
			beforeSend: function(xhr) {
				xhr.setRequestHeader("token", window.sessionStorage.getItem('token'));
