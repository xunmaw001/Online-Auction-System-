		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑用户评价</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>用户评价管理</span></li>
								<li class="breadcrumb-item active"><span>编辑用户评价</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">用户评价信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									<input id="updateId" name="id" type="hidden">
									<div class="form-group col-md-6">
										<label>订单编号</label>
										<input name="dingdanbianhao" id="dingdanbianhao" name="dingdanbianhao" class="form-control" placeholder="订单编号">
									</div>
									<div class="form-group col-md-6">
										<label>商品名称</label>
									...
									<div class="form-group col-md-6">
										...
										<div id="pingjiashijianDate" class="input-append date form_datetime">
											<input id="pingjiashijian-input" name="pingjiashijian" size="15" type="text" readonly>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "yonghupingjia/info/" + id,
				...
				if(crossrefid && crossuserid) {
					...
					http("yonghupingjia/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("yonghupingjia/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("yonghupingjia/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function dateTimePick(){
			...
			$("#pingjiashijian-input").val(getCurDate());
		...
		function calculationSE(colName){
			//单列求和接口
			http("yonghupingjia"+colName,"GET",{
