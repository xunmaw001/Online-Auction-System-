		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑用户竞拍</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>用户竞拍管理</span></li>
								<li class="breadcrumb-item active"><span>编辑用户竞拍</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">用户竞拍信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>竞拍价格</label>
										<input name="jingpaijiage" id="jingpaijiage" name="jingpaijiage" class="form-control" placeholder="竞拍价格">
									</div>
									<div class="form-group col-md-6">
										<label>用户出价</label>
										<input name="yonghuchujia" id="yonghuchujia" name="yonghuchujia" class="form-control" placeholder="用户出价">
									</div>
									<div class="form-group col-md-6">
										<label>出价时间</label>
										<div id="chujiashijianDate" class="input-append date form_datetime">
											<input id="chujiashijian-input" name="chujiashijian" size="20" type="text" readonly>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "yonghujingpai/info/" + id,
				...
				if(crossrefid && crossuserid) {
					...
					http("yonghujingpai/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("yonghujingpai/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("yonghujingpai/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function dateTimePick(){
			...
			$("#chujiashijian-input").val(getCurDateTime());
			$("#chujiashijianDate").datetimepicker({ 
				autoclose: true,
		...
		function calculationSE(colName){
			//单列求和接口
			http("yonghujingpai"+colName,"GET",{
		...
		function dataBind(){
			...
			$("#jingpaijiage").val(ruleForm.jingpaijiage);	
			$("#yonghuchujia").val(ruleForm.yonghuchujia);	
			$("#chujiashijian-input").val(ruleForm.chujiashijian);
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.jingpaijiage != null && res.data.jingpaijiage != ''){

						$("#jingpaijiage").val(res.data.jingpaijiage);
						$("#jingpaijiage").attr('readonly','readonly');
					}
					if(res.data != null && res.data != '' && res.data.yonghuchujia != null && res.data.yonghuchujia != ''){

						$("#yonghuchujia").val(res.data.yonghuchujia);
						$("#yonghuchujia").attr('readonly','readonly');
					}
					if(res.data != null && res.data != '' && res.data.chujiashijian != null && res.data.chujiashijian != ''){

						$("#chujiashijian-input").val(res.data.chujiashijian);
						$('#chujiashijianFileName').val(res.data.chujiashijian)
					}
		...
		function compare(){
			var largerVal = null;
			var smallerVal = null;
			var smallerVal = $('#jingpaijiage').val();
			var smallerName = '竞拍价格';
			var largerVal = $('#yonghuchujia').val();
			var largerName = '用户出价';
