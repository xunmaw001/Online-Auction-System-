...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">用户竞拍管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>用户竞拍列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">用户竞拍列表</h3>							
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('jingpaijiage')">竞拍价格<i id="jingpaijiageIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('yonghuchujia')">用户出价<i id="yonghuchujiaIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('chujiashijian')">出价时间<i id="chujiashijianIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var jingpaijiageCell  = document.createElement('td');

						 jingpaijiageCell.innerHTML = item.jingpaijiage;

			row.appendChild(jingpaijiageCell);
			var yonghuchujiaCell  = document.createElement('td');

						 yonghuchujiaCell.innerHTML = item.yonghuchujia;

			row.appendChild(yonghuchujiaCell);
			var chujiashijianCell  = document.createElement('td');

						  chujiashijianCell.innerHTML = item.chujiashijian;


			row.appendChild(chujiashijianCell);
			...
			var crossBtn0 = document.createElement('button');
            		crossBtn0.innerHTML = "通知"
			crossBtn0.setAttribute("type","button");
			crossBtn0.setAttribute("class","btn btn-primary btn-sm");
			crossBtn0.setAttribute("onclick","crossTable(" + JSON.stringify(item) + ",'chengjiaotongzhi','','[1]','请勿重复通知！')");
			if(crossBtnControl('通知') == true){
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("yonghujingpai/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"yonghujingpai");
