				...
				<form class="layui-form layui-form-pane add" lay-filter="myForm">
		            ...
		            <div :style='{"padding":"10px","boxShadow":"0 0 0px rgba(110,22,64,.8)","margin":"0 0 10px 0","borderColor":"rgba(110,22,64,.3)","backgroundColor":"#fff","borderRadius":"4px","borderWidth":"0","borderStyle":"solid"}' class="layui-form-item" pane>
						...
						<div v-if="detail.value" class="layui-input-block">
							...
							<input :style='{"padding":"0 12px","boxShadow":"0 0 0px rgba(110,22,64,.8)","borderColor":"rgba(132, 132, 132, 1)","backgroundColor":"#fff","color":"rgba(0, 0, 0, 1)","borderRadius":"0","textAlign":"left","borderWidth":"1px","fontSize":"14px","borderStyle":"solid","height":"40px"}' type="hidden" :value="detail.value" id="value" name="value" />
						</div>
						<div class="layui-input-block">
							<button v-if="!ro.value" :style='{"padding":"0 16px","boxShadow":"0 0 6px #5D7599","margin":"0 10px 0 0","borderColor":"#ccc","backgroundColor":"rgba(93, 117, 153, 1)","color":"#fff","borderRadius":"24px","borderWidth":"0","width":"auto","fontSize":"14px","borderStyle":"solid","height":"44px"}' type="button" class="layui-btn btn-theme" id="valueUpload">
